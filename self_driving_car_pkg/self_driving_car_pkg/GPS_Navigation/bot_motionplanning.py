...
# Try to initialize the mixer, but continue if it fails (no audio device)
try:
    pygame.mixer.init()
    print("Pygame mixer initialized successfully")
except pygame.error:
    print("Warning: Pygame mixer initialization failed - continuing without audio")
            ...
            if self.path_iter==(len(path)-1):
                ...
                if (self.goal_not_reached_flag and (distance_to_goal<=10)):
                    ...
                    try:
                        ...
                        print("Goal reached! Playing celebration sound.")
                    except Exception as e:
                        print("Goal reached! (Audio playback not available)")
